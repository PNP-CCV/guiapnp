...
<table>
  ...
  <tr>
    <td colspan="2">
      <strong>Polaridade:</strong> Decrescente (quanto menor, melhor).
    </td>
  </tr>
  <tr>
    <td>
  ...
  <tr>
    <td colspan="2">
      ...
      <strong>CMAG - Consumo mensal de água.</strong><br/>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <p style="text-align:center"><strong>Variáveis</strong></p>
      <strong>CMEE - Consumo mensal de energia elétrica.</strong><br/>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <p style="text-align:center"><strong>Variáveis</strong></p>
      <strong>PMER - Produção mensal de energia elétrica de fonte renovável.</strong><br/>
...
<table>
  ...
  <tr>
    <td colspan="2">
      <p style="text-align:center"><strong>Variáveis</strong></p>
      <strong>IG – Instâncias de Governança.</strong><br/>
      <strong>Fonte:</strong> Registros realizados pelas instituições.<br/>
      <strong>Definição:</strong> Instâncias de Governança: compreende o somatório das instâncias de governança formalmente instituídas para coordenar e/ou executar a política de sustentabilidade institucional, sendo elas:
      <ul>
        <li>COO – coordenação</li>
        <li>DEP – departamento</li>
        <li>DIR – diretoria</li>
        <li>PRO – pró-reitoria</li>
        <li>COM – comissão</li>
        <li>NUC – núcleo</li>
        <li>GT – grupo de trabalho</li>
        <li>CAM – câmara</li>
        <li>CON – conselho</li>
        <li>CMT – comitê</li>

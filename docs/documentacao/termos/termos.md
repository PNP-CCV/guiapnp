...
__Matrícula atendida:__ são as matrículas que estiveram ativas em pelo menos um dia no ano de referência. Um estudante pode ter mais de uma matrícula nesse período, caso tenha se matriculado em mais de um curso. Clique [aqui]({{site.baseUrl}}/guiapnp/documentacao/usuarios-especializados/situacoes_matriculas){:target="_blank"} para mais detalhes sobre esse conceito.

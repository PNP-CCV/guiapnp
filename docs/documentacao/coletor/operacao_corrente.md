...
- Não disparar "Extrair Dados" num **Modelo sem Configuração de Extração**. O botão individual do modelo não bloqueia a ação, mas a execução falha com "Nenhum dataset foi gerado" e deixa um registro de falha inútil no histórico.

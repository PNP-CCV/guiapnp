...
![Wizard de 8 passos no dashboard](/guiapnp/assets/img/docs/coletor/02-dashboard-wizard-passo1.png)
...
![Cadastro de provedor de planilha online](/guiapnp/assets/img/docs/coletor/03-provedor-planilha.png)
...
![Lista de configurações de extração](/guiapnp/assets/img/docs/coletor/16-configs-extracao-lista.png)
...
![Modal de teste de extração](/guiapnp/assets/img/docs/coletor/04-config-testar-extracao.png)
...
![Dashboard com extração em andamento](/guiapnp/assets/img/docs/coletor/14-dashboard-configs-completas.png)
...
![Pré-visualização do parquet gerado](/guiapnp/assets/img/docs/coletor/24-modelo-previa-parquet.png)
...
![Resultados dos testes por campo](/guiapnp/assets/img/docs/coletor/28-resultados-testes-contrato.png)
...
![Contrato pronto para sincronizar](/guiapnp/assets/img/docs/coletor/06-contrato-pronto-sincronizar.png)
...
![Contrato aguardando aprovação do reitor](/guiapnp/assets/img/docs/coletor/10-coletor-aguardando-reitor.png)
...
1. **Homologação da Área** — o Gestor de Área Temática revisa a "Fila de Homologação" da sua área e homologa ou **rejeita com justificativa** (que volta ao Coletor para correção). Antes de decidir, ele pode pré-visualizar o conteúdo real do dataset.
   ...
   ![Fila de homologação na PNP](/guiapnp/assets/img/docs/coletor/07-pnp-fila-homologacao.png)
...
2. **Aprovação do Reitor** — só chega ao Reitor o que a área já homologou. A visão é institucional (todas as áreas de uma vez) e a decisão é terminal: neste nível só existe aprovar.
   ...
   ![Fila de aprovação do reitor na PNP](/guiapnp/assets/img/docs/coletor/11-pnp-fila-reitor.png)
...
![Contrato aprovado pelo reitor](/guiapnp/assets/img/docs/coletor/13-coletor-aprovado-reitor.png)

Quando todos os contratos fecham, o wizard marca 8/8:

![Dashboard com o fluxo completo](/guiapnp/assets/img/docs/coletor/29-dashboard-fluxo-completo.png)

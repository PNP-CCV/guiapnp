...
O principal canal de suporte se dá com a abertura de chamados individuais por e-mail para [pnp.suporte@mec.gov.br](mailto://pnp.suporte@mec.gov.br). Cada e-mail gera um ticket que é absorvido pela equipe de suporte para atendimento à demanda especificada. Por meio da ferramenta de controle de tickets, é possível manter todo o histórico de atendimento, mensurar tempo médio entre respostas e avaliar se houve feedback por parte da instituição que demandou o suporte.
...
![Exemplo de registro de ticket de atendimento]({{ site.baseurl }}/assets/img/docs/ccv_produto_de_suporte_01.png "Exemplo de registro de ticket de atendimento")
...
![Gráfico de evolução de abertura de tickets]({{ site.baseurl }}/assets/img/docs/ccv_produto_de_suporte_02.png "Gráfico de evolução de abertura de tickets")
...
![Exemplo de relatório de totais de vagas e matrículas 2023 x 2024]({{ site.baseurl }}/assets/img/docs/ccv_produto_de_suporte_02.png "Exemplo de relatório de totais de vagas e matrículas 2023 x 2024")

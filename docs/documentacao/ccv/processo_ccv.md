...
Os Ciclos de Coleta e Validação são estabelecidos a partir da definição do escopo dos dados tratados no ciclo, das regras de consistência para cada conjunto de dados e do cronograma de etapas para o ciclo. O escopo dos dados tratados no ciclo implica na definição do conjunto de sistemas e respectivas bases de dados que serão necessárias para a coleta. As [regras de consistência]({{baseUrl}}/guiapnp/documentacao/usuarios-especializados/regras_de_consistencia) possibilitam qualificar os dados coletados para que sejam transformados em informações válidas e consistentes. O cronograma das fases de coleta e de validação apresenta uma visão geral das interações e ações dos atores das instituições responsáveis pelos dados e da equipe responsável pela operacionalização do ciclo de coleta e validação.
